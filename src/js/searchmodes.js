...
const searchModes = [
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: searchTypes.SINGLE,
        func: (word, num) => (x) =>
          Wordplay.areAlmostAnagrams(x, word, parseInt(num)),
      },
      {
        value: 'letter-bank',
        label: 'Letter bank',
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: 'delete-one',
        label: 'Add or remove one',
        desc: 'Pairs of words formed by adding or removing one instance of a group of letters; e.g. removing T yields MEDITATE → MEDIATE.',
        fields: ['Add or remove one'],
        type: searchTypes.MULTIPAIRS,
        func: (str) => (x) => Wordplay.replaceOne(x, str, ''),
      },
      {
        value: 'delete-all',
        label: 'Add or remove all',
        desc: 'Pairs of words formed by adding or removing all instances of a group of letters; e.g. removing ER yields DERRIERES → DRIES.',
        fields: ['Add or remove all'],
        type: searchTypes.PAIRS,
      ...
      },
      {
        ...
        type: searchTypes.PAIRS,
        func: () => (x) =>
          x.endsWith('S') && !x.endsWith('SS') ? '' : x.slice(0, x.length - 1),
      },
      {
        value: 'sidesplitting',
