    ...
    return (
      <div className="wordlist-list">
        ...
        <div className="wordlist-buttons">
          <button
            className="wordlist-button add-wordlist-button nice-button small-button"
            onClick={this.props.onWordlistAdd}
          >
            Add list
          </button>
          <button
            className="wordlist-button change-wordlist-button nice-button small-button blue-button"
            onClick={this.props.onWordlistChange}
          >
            Reset
          </button>
        </div>
