    ...
    render() {
        return (
            <div className="results-count-navigator">
                <button
                    disabled={!(this.props.numResults > this.props.maxResults && this.props.firstIndex >= this.props.maxResults)}
                ...
                {this.props.numResults > this.props.maxResults && 
                    <span className="results-count-specifier">
                        {this.props.firstIndex + 1}–{Math.min(this.props.firstIndex + this.props.maxResults, this.props.numResults)}
                    </span>
                }

                <button
                    disabled={!(this.props.numResults > this.props.maxResults && this.props.firstIndex < this.props.numResults - this.props.maxResults)}
